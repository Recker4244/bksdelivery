              ...
              return SafeArea(
                  ...
                  child: Container(
                    ...
                    child: Row(
                      ...
                      children: [
                        InkWell(
                          onTap: () {
                            buyByWeight(double.parse(data.kt24.buy.toString()));
                          },
                          child: Container(
                            height: 4.h,
                            width: (width - 1.0) / 2,
                        ...
                        InkWell(
                          onTap: () {
                            buyByValue(double.parse(data.kt24.buy.toString()));
                          },
                          child: Container(
                            height: 4.h,
                            width: (width - 1.0) / 2,
                ...
                body: SafeArea(
                  child: ListView(
                    ...
                    children: [
                      //currencyPriceChart(data.kt24.buy),
                      aboutPortfolio(),
                    ],
                  ),
                ),
      ...
      child: Column(
        ...
        children: [
          ...
          Row(
            ...
            crossAxisAlignment: CrossAxisAlignment.start,
            children: [
              aboutPortfolioItem('Average Buy Price', data.kt24.buy),
              Container(
                height: 75.0,
                                ...
                                Navigator.push(
                                  ...
                                  PageTransition(
                                    ...
                                    child: BuySuccessScreen(
                                      text:
                                          "You have successfully buy ${valueController.text}  Gram of Gold at price of INR ${amountController.text}",
                                    ),
                                  ),
                                );
                              } else {
