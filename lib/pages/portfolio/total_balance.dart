...
class TotalBalance extends StatefulWidget {
  ...
  const TotalBalance({Key key, this.sub}) : super(key: key);
      ...
      child: Container(
        ...
        child: Column(
          ...
          children: [
            ...
            heightSpace,
            Text(
              "${widget.sub.savedWeight.toString()} GRAM",
            ...
            Container(
              ...
              child: Row(
                ...
                crossAxisAlignment: CrossAxisAlignment.center,
                children: [
                  depositWithdrawalItem('Total Saved',
                      "${widget.sub.savedWeight.toString()} GRAM"),
                  Container(
                    height: 34.0,
                    width: 0.7,
                  ...
                  depositWithdrawalItem('Bonus Earned',
                      '${widget.sub.totalBonus.toString()} GRAM'),
                ],
              ),
            ),
          ],
                      ...
                      children: [
                        Container(
                          ...
                          decoration: BoxDecoration(
                              ...
                              color: greenColor),
                          child: Icon(
                            item.statustype == "hold"
                                ? Icons.close
                                : item.statustype == "saved" ||
                                        item.statustype == "hold"
                                    ? Icons.call_received
